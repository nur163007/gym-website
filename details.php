		...
		<div class="container">
			...
			<div class="nav">
				<ul>
					...
					<li><a href="allimage.php">Gallary</a></li>
				</ul>
			</div>
		</div>
	</header>
				...
				while($data=mysqli_fetch_assoc($result)){
					...
					<div class="portfolio app mix_all" data-cat="app">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<div class="row">
							<div class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim col-md-6 col-6 text-center">
								<img src="admin/packimages/<?php echo $data['package_image']; ?>"  alt=""/>
							</div>
							<div class="col-md-6 col-6">
								<h2>Package Name: <span class="h5"><?php echo $data['package_name'];?></span> </h2>
								<h2>Package Details: <span class="h5"><?php echo $data['package_details'];?></span> </h2>
							</div>
							</div>
						</div>
					</div>
