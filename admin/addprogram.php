			...
			<div class="col-sm-9">
				...
				<form method="post" enctype="multipart/form-data">
					<table border="0" width="480px" height="430px" align="center" class="tableshadow">
						<tr><td colspan="2" class="toptd">Add Program</td></tr>

						<tr><td class="lefttxt">Program Name</td><td><select name="program_name" required/>
							<option value="">---Select One---</option>
							<option value="Corporate Membership Program">Corporate Membership Program</option>
							<option value="Personal Training Program ">Personal Training Program </option>
							<option value="Quick Results Program">Quick Results Program</option>
						...
						<tr><td class="lefttxt">Long Description</td><td><textarea type="text" name="long_description"></textarea></td></tr>

						<tr><td class="lefttxt">Program Image</td><td><input type="file" name="program_image" /></td></tr>
...
include ('../dbConnect.php');
	...
	//check file size
	if($_FILES["program_image"]["size"]>700000){
	...
	if($imagefiletype != "jpg" && $imagefiletype !="png" && $imagefiletype !="jpeg" && $imagefileype !="gif" && $imagefiletype != "PNG"){
		...
		if(move_uploaded_file($_FILES["program_image"]["tmp_name"], $target_file)){
			$f1=1;
	} else{
	...
	$s="insert into program(program_name,short_description,long_description,image) values('" . $_POST["program_name"] ."','" . $_POST["short_description"] ."','" . $_POST["long_description"] ."','" . basename($_FILES["program_image"]["name"]) ."')";
