...
<tr><td class="lefttxt">Package Name</td><td><select name="package_name" required/>
...
<tr><td class="lefttxt">Package Image</td><td><input type="file" name="package_image" /></td></tr>

<tr><td class="lefttxt">Package Details</td><td><textarea name="package_details"></textarea></td></tr>
...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
	...
	//check file size
	if($_FILES["package_image"]["size"]>700000){
	...
	$s="insert into package(package_name,package_image,package_details) values('" . $_POST["package_name"] ."','" . basename($_FILES["package_image"]["name"])  ."','" . $_POST["package_details"] ."')";
