...
if(isset($_POST["sbmt"]))
{
	...
	$s="delete  from service where service_id='" . $_POST["sid"] . "'";
	mysqli_query($conn,$s);
	mysqli_close($conn);
...
<tr><td colspan="2" class="toptd">Delete Service</td></tr>
<tr><td class="lefttxt">Select Service Name</td><td><select name="sid" required/><option value="">Select</option>
...
?>
<tr><td class="lefttxt"></td><td><img src="service/<?php echo $image; ?>" width="150px" height="50px" />
