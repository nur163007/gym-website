...
if(isset($_POST["sbmt"]))
{
 ...
 //    exit();
	...
	$s="delete from program  where program_id='" . $_POST["id"] . "'";
	mysqli_query($conn,$s);
	mysqli_close($conn);
						...
						<div class="page-header float-right">
							<div class="page-title">
								<ol class="breadcrumb text-right">
									...
									<li class="active">Delete Program</li>
								</ol>
							</div>
						</div>
					</div>
...
<tr><td colspan="2" class="toptd">Delete Program</td></tr>
<tr><td class="lefttxt">Select Program</td><td><select name="id" required/><option value="">Select</option>
...
{
include ('../dbConnect.php');
$s="select * from program where program_id='" .$_POST["id"] ."'";
$result=mysqli_query($conn,$s);
$r=mysqli_num_rows($result);
//echo $r;
